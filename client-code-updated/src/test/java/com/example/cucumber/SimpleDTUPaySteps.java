...
public class SimpleDTUPaySteps {
  ...
  @Given(
      "a successful payment of {int} kr from customer {string} to merchant {string}")
  public void
  a_successful_payment_of_kr_from_customer_to_merchant(Integer int1,
                                                       String string,
                                                       String string2) {
  ...
  @Then(
      "the list contains a payments where customer {string} paid {int} kr to merchant {string}")
  public void
  the_list_contains_a_payments_where_customer_paid_kr_to_merchant(
